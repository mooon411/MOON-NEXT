      ...
      <section id="log" className="container">
        ...
        <div className="log_moment">
          <ul className="line_one">
            <li>
              <div className="log_img">
                <Image src={log01Img} alt="log_moment" layout="responsive" />
              </div>
              <p>steady development</p>
            </li>
            <li>
              <div className="log_img">
                <Image src={log02Img} alt="log_moment" layout="responsive" />
              </div>
          ...
          <ul className="line_two">
            <li>
              <div className="log_img">
                <Image src={log03Img} alt="log_moment" layout="responsive" />
              </div>
              <p>rest breathing</p>
            </li>
            <li>
              <div className="log_img">
                <Image src={log04Img} alt="log_moment" layout="responsive" />
              </div>
              <p>healthy food</p>
            </li>
            <li>
              <div className="log_img">
                <Image src={log05Img} alt="log_moment" layout="responsive" />
              </div>
              <p>health</p>
            </li>
          </ul>
